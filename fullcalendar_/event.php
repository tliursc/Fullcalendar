...
<div class="fancy">
    ...
    <!--p>日程内容：<input type="text" class="input" name="event" id="event" style="width:240px;height:120px;text-align:top" placeholder="记录日程..."/></p-->
    <p>日程内容：<textarea class="input" name="event" id="event" style="width:240px;height:120px;" placeholder="输入日程..."></textarea></p>
	...
	<!--label>Color: <input type="color" name="user_color" /></label可选颜色-->
    </p>
...
<div class="fancy">
    ...
    <!--p>日程内容：<input type="text" class="input" name="event" id="event" style="width:240px;height:120px" placeholder="记录日程..." value="<!--?php echo $title;?>"></p-->
	<p>日程内容：<textarea class="input" name="event" id="event" style="width:240px;height:120px" placeholder="输入日程" ><?php echo $title;?></textarea></p>
